...
const FALLBACK_TESTIMONIALS: Testimonial[] = [
  {
    ...
    quote: 'Mansa Luxe Realty Limited made our property search seamless. Their team understood our requirements and delivered beyond expectations. Highly recommend for anyone seeking luxury real estate in Nigeria.',
    rating: 5,
    property_id: null,
  ...
  },
  {
    ...
    quote: 'Outstanding service from start to finish. The team\'s market knowledge and negotiation skills ensured we got the best value. Mansa Luxe Realty Limited is now our go-to for all property investments.',
    rating: 5,
    property_id: null,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
