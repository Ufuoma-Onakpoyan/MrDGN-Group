...
async function main() {
  ...
  const promoPost = {
    slug: PROMO_SLUG,
    title: 'Buy 10,000 Cement Blocks – Get 30 Free. Free Delivery Only Within Asaba & Okpanam',
    excerpt: 'Limited-time offer: order 10,000 cement blocks and get 30 free. Free delivery only within Asaba and Okpanam. Quality blocks for quality homes.',
    content: `<h2>Special Offer: Buy 10,000 Blocks, Get 30 Free</h2><p>MR DGN Constructions is pleased to announce a limited-time promotion for our customers in Asaba and Okpanam. When you order <strong>10,000 cement blocks</strong>, you'll receive <strong>30 blocks free</strong>. <strong>Free delivery applies only within Asaba and Okpanam.</strong></p><h3>Quality Blocks for Quality Homes</h3><p>Our cement blocks are produced to high standards, giving you reliable materials for strong, durable builds. Whether you're working on a residential or commercial project, this offer helps you save while stocking up on quality construction materials.</p><h3>How to Order</h3><p>Contact us via WhatsApp or our contact page to place your order or request a quote. Our team will confirm availability, pricing, and delivery details. Offer valid while stocks last. Remember: free delivery is only within Asaba and Okpanam.</p><p><em>Quality blocks for quality homes – MR DGN Constructions, your building materials partner in Asaba.</em></p>`,
    author: 'MR DGN',
